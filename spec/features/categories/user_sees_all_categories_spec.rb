...
RSpec.feature "User sees a list of all categories" do
  scenario "when visiting the category index page" do
    category1 = Category.create(title: "Backend Development")
    category2 = Category.create(title: "Engineering")
    category3 = Category.create(title: "Database Management")
    category4 = Category.create(title: "Frontend Development")
    ...
    expect(cat1).to have_link("Delete", href: category_path(category1))
    ...
    expect(cat2).to have_link("Delete", href: category_path(category2))
    ...
    expect(cat3).to have_link("Delete", href: category_path(category3))
    ...
    expect(cat4).to have_link("Delete", href: category_path(category4))
